...
export const Navbar = () => {
    ...
    return (
        ...
        >
                    ...
                    <div className="glass rounded-full px-2 py-1 flex items-center gap-1">
                        {navLinks.map((link, index) => (
                            <a 
                                href={link.href} 
                                key={index} 
                                className="px-4 py-2 text-sm text-muted-foreground hover:text-foreground rounded-full hover:bg-white/10 transition-all"
                            >
                                {link.label}
                            </a>
                        ))}
            ...
            {/* Mobile Menu Content */}
            {isMobileMenuOpen && (
                <div className="md:hidden glass-strong animate-in fade-in slide-in-from-top-4 duration-300">
